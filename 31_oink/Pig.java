...
public class Pig
{
  ...
  {
      System.out.println("yes".indexOf("es"));
      System.out.println(hasA("green", "g"));
      System.out.println(isAVowel("h"));
      System.out.println(countVowels("yellow"));
      System.out.println(hasAVowel("qqq"));
      System.out.println(allVowels("purple"));
  }//end main()
